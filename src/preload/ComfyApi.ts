class ComfyApi extends EventTarget {
	...
	constructor() {
		...
		this.api_host = '127.0.0.1:8188';
		this.api_base = '';
	}

	apiURL(route: string) {
		return `http://${this.api_host}${this.api_base}${route}`;
	}
	...
	addEventListener(type: any, callback: EventListenerOrEventListenerObject | null, options: boolean | AddEventListenerOptions | undefined) {
	 ...
	 */
	#createSocket(isReconnect: any = null) {
		if (this.socket) {
			return;
		}
	 ...
	 */
	async deleteItem(type: any, id: any) {
